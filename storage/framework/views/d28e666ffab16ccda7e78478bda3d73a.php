...
<div class="<?php echo e((isset($is_pdf) && $is_pdf) ? 'date-section' : 'text-right text-sm mb-3'); ?>" style="<?php echo e((isset($is_pdf) && $is_pdf) ? 'text-align: right;' : ''); ?>">
    <p>Bogor, <?php echo e(\Carbon\Carbon::parse($pangkatgajitunjangan->created_at)->format('d F Y')); ?></p>
</div>
...
<div class="<?php echo e((isset($is_pdf) && $is_pdf) ? 'text-sm mb-4' : 'text-sm mb-4'); ?>">
    ...
    <table style="width: 100%; border-collapse: collapse; margin-left: 15px;">
        <tr>
            ...
            <td style="width: 74%; padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->pegawai->nomor_urut_pegawai ?? '[Nomor Induk Pegawai Anda]'); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Nama Pegawai</td>
            <td style="padding: 2px 0;">:</td>
            <td style="padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->pegawai->nama ?? '[Nama Lengkap Anda]'); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Divisi</td>
            <td style="padding: 2px 0;">:</td>
            <td style="padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->pegawai->pekerjaan->divisi->nama_divisi ?? '[Divisi Pegawai]'); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Jabatan</td>
            <td style="padding: 2px 0;">:</td>
            <td style="padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->pegawai->pekerjaan->jabatan ?? '[Jabatan Anda]'); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Pangkat/Grade</td>
            <td style="padding: 2px 0;">:</td>
            <td style="padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->pegawai->pekerjaan->pangkat ?? '[Pangkat Anda]'); ?> / <?php echo e($pangkatgajitunjangan->pegawai->pekerjaan->grade ?? '[Grade Anda]'); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Status Pegawai</td>
            <td style="padding: 2px 0;">:</td>
            <td style="padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->pegawai->pekerjaan->status_pegawai ?? '[Pangkat Anda]'); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">TMT Pegawai</td>
            <td style="padding: 2px 0;">:</td>
            <td style="padding: 2px 0;"><strong><?php echo e($formatDate($pangkatgajitunjangan->tmt_pegawai)); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Lama Bergabung</td>
            <td style="padding: 2px 0;">:</td>
            <td style="padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->masa_kerja ?? '[Lama Bergabung Pegawai]'); ?></strong></td>
        </tr>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-left: 15px;">
        <tr>
            ...
            <td style="width: 1%; padding: 2px 0;">:</td>
            <td style="width: 74%; padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->jenis_pengajuan ?? '[Jenis Pengajuan Kenaikan yang diambil]'); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Pangkat Tujuan</td>
            <td style="padding: 2px 0;">:</td>
            <td style="padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->pangkat_tujuan ?? '[Pangkat Tujuan]'); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Grade Tujuan</td>
            <td style="padding: 2px 0;">:</td>
            <td style="padding: 2px 0;"><strong><?php echo e($pangkatgajitunjangan->grade_tujuan ?? '[Grade Tujuan]'); ?></strong></td>
        </tr>
    </table>
...
<div class="mb-4">
    <table style="width: 100%; border-collapse: collapse;" class="text-sm">
        ...
        <tbody>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $pangkatgajitunjangan->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
...
<?php if(isset($pangkatgajitunjangan->logPersetujuanPangkatgajitunjangan) && count($pangkatgajitunjangan->logPersetujuanPangkatgajitunjangan) > 0): ?>
...
<div class="text-left mt-4">
    ...
    <p class="text-sm font-semibold mt-4"><?php echo e($pangkatgajitunjangan->pegawai->nama ?? '[Nama Lengkap Anda]'); ?></p>
    <p class="text-sm font-semibold"><?php echo e($pangkatgajitunjangan->pegawai->pekerjaan?->jabatan ?? 'Pegawai'); ?></p>
</div>
