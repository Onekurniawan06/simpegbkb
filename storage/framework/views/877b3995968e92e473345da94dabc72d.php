                            ...
                            <tr class="bg-white hover:bg-blue-50/50 transition-colors duration-150 h-px">
                                ...
                                <td class="px-2 py-1.5 border-b border-gray-200 text-center">
                                    <div class="flex flex-row justify-center items-center gap-1.5 whitespace-nowrap">
                                        <a href="<?php echo e(route('skkmr.detailApproval', ['sumber' => $item->sumber, 'id_log' => $item->id_transaksi])); ?>" class="bg-[#001f3f] hover:bg-black text-white py-1 px-2 rounded text-[8px] font-bold tracking-tighter transition shadow-sm">DETAIL</a>
...
<?php echo $__env->make('layouts.app-skkmr', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\simpegbkb\resources\views/skkmr/manajemenpengajuanpegawai.blade.php ENDPATH**/ ?>