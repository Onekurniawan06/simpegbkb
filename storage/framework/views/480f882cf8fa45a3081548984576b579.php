            ...
            <nav id="sidebar-content" class="flex-1 px-3 py-3 space-y-1 overflow-y-auto scrollbar-none">
                ...
                <div class="relative group">
                    ...
                    <div class="max-h-0 overflow-hidden group-hover:max-h-40 transition-all duration-300 ease-in-out bg-emerald-900/30 rounded-lg mx-1 border border-emerald-800/30">
                        <a href="<?php echo e(url('/manager/pengajuanmanager')); ?>" class="block p-2 text-xs font-semibold text-white/80 hover:bg-amber-500/10 hover:text-amber-500 transition-colors border-b border-emerald-800/20 pl-11">
                            Pengajuan Saya
                        </a>
                        <a href="<?php echo e(url('/manager/manajemenpengajuanmanager')); ?>" class="block p-2 text-xs font-semibold text-white/80 hover:bg-amber-500/10 hover:text-amber-500 transition-colors pl-11">
                            Approval Pengajuan
                        </a>
                    </div>
                </div>
                ...
                <!-- Menu Data Pegawai -->
                <div class="relative group">
                    <a href="<?php echo e(route('manager.pegawaidivisi')); ?>" class="flex items-center justify-between p-2.5 text-xs font-semibold rounded-xl hover:bg-amber-500 hover:text-white transition-all duration-200 cursor-pointer">
                        <span class="flex items-center overflow-hidden">
                            ...
                            <span class="sidebar-text whitespace-nowrap overflow-hidden text-ellipsis">
                                <?php if($isManagerBiasa): ?>
                                    Pegawai Divisi <?php echo e(auth()->user()->divisi->nama_divisi ?? 'Divisi'); ?>
                ...
                <a href="#" class="flex items-center justify-between p-2.5 text-xs font-semibold rounded-xl hover:bg-amber-500 hover:text-white transition-all duration-200 cursor-pointer group">
                    <span class="flex items-center overflow-hidden">
                        ...
                        <span class="sidebar-text whitespace-nowrap overflow-hidden text-ellipsis">
                            <?php if($isManagerBiasa): ?>
                                Absensi Pegawai Divisi <?php echo e(auth()->user()->divisi->nama_divisi ?? 'Divisi'); ?>
                ...
                <a href="<?php echo e(route('laporan.index')); ?>" class="flex items-center justify-between p-2.5 text-xs font-semibold rounded-xl hover:bg-amber-500 hover:text-white transition-all duration-200 cursor-pointer group">
                    <span class="flex items-center overflow-hidden">
                        ...
                        <span class="sidebar-text whitespace-nowrap overflow-hidden text-ellipsis">
                            <?php if($isManagerBiasa): ?>
                                Pengajuan Pegawai Divisi <?php echo e(auth()->user()->divisi->nama_divisi ?? 'Divisi'); ?>
...
<?php /**PATH C:\xampp\htdocs\simpegbkb\resources\views/layouts/app-manager.blade.php ENDPATH**/ ?>