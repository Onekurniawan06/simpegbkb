...
<div class="bg-white border-b border-gray-100 max-w-full py-4 shadow-sm">
    <div class="max-w-2xl mx-auto px-6">
        <div class="relative">
            ...
            <!-- Garis Progres -->
            <div class="absolute top-5 left-0 <?php echo e($lineWidth); ?> h-1 <?php echo e($activeBg); ?> mx-[16.6%] transition-all duration-700 ease-in-out rounded-full shadow-sm"></div>
            <div class="relative flex justify-between items-start">

                <!-- STEP 1: Pengajuan -->
                <div class="flex flex-col items-center w-1/3">
                    <!-- Ditambahkan inline style transition & hover scale -->
                    <div class="w-10 h-10 rounded-full <?php echo e($activeBg); ?> <?php echo e($activeRing); ?> border-[5px] flex items-center justify-center z-10 shadow-sm cursor-pointer"
                ...
                <div class="flex flex-col items-center w-1/3">
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <p class="text-xs font-bold <?php echo e($textColor); ?> mt-2 bg-gray-50 px-2 py-0.5 rounded-full inline-block">
                            <?php echo e(\Carbon\Carbon::parse($data->tanggal_proses)->format('d/m/Y H:i')); ?>
                ...
                <!-- STEP 3: Selesai -->
                <div class="flex flex-col items-center w-1/3">
                    <div class="w-10 h-10 rounded-full <?php echo e($isProcessed ? $activeBg.' '.$activeRing : 'bg-gray-100 border-gray-50'); ?> border-[5px] flex items-center justify-center z-10 shadow-sm cursor-pointer"
                        style="transition: transform 0.2s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.3)'"
                        onmouseout="this.style.transform='scale(1)'">
                        <div class="w-2 h-2 bg-white rounded-full"></div>
                    </div>
                    <div class="mt-4 text-center <?php echo e($isProcessed ? '' : 'opacity-40'); ?>">
                        <p class="text-xs font-bold <?php echo e($isProcessed ? $textColor : 'text-gray-400'); ?> uppercase tracking-widest text-opacity-70">Tahap 3</p>
                        <p class="text-sm font-semibold <?php echo e($isProcessed ? 'text-gray-900' : 'text-gray-400'); ?> mt-1">Selesai</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-2 flex flex-col min-h-0 overflow-y-auto p-4 bg-slate-50/30">
            ...
            <div class="grid grid-cols-2 gap-8 mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-indigo-600 font-medium"><?php echo e($sumber == 'cuti' ? $data->Jenis_cuti : 'Lembur Kerja'); ?></p>
                </div>
            </div>
