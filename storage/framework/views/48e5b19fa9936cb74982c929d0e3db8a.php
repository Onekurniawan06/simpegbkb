...
<div class="flex flex-col items-center flex-1 relative">
    ...
    <?php else: ?>
        <div class="absolute top-5 left-1/2 w-full h-[2.5px] z-0 <?php echo e((isset($isFinalApproved) && $isFinalApproved) ? 'bg-emerald-500' : 'bg-gray-100'); ?>"></div>
    <?php endif; ?>

    <!-- Bulatan -->
    <div class="w-10 h-10 rounded-full <?php echo e($circleClass); ?> border-[5px] flex items-center justify-center z-10 transition-all duration-300">
        <?php if($isDone): ?>
    ...
    <div class="mt-4 text-center px-2">
        ...
        <p class="text-[9px] font-bold <?php echo e($isDone ? 'text-emerald-600' : ($isCurrent ? 'text-orange-600' : ($isRejected ? 'text-red-600' : 'text-gray-400'))); ?> mt-1 italic uppercase">
        ...
        <?php if($waktuTampil): ?>
            <div class="mt-2">
                <p class="text-[9px] text-gray-500 font-medium whitespace-nowrap">
                    <?php echo e(\Carbon\Carbon::parse($waktuTampil)->translatedFormat('d M Y')); ?>

                    <span class="text-gray-400 ml-1"><?php echo e(\Carbon\Carbon::parse($waktuTampil)->format('H:i')); ?> WIB</span>
                </p>
            </div>
        <?php endif; ?>
    </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <!-- TITIK AKHIR (DINAMIS) -->
            <div class="flex flex-col items-center flex-1 relative">
                <div class="w-10 h-10 rounded-full <?php echo e($isFinalApproved ? 'bg-emerald-500 border-emerald-100' : 'bg-gray-100'); ?> border-[5px] flex items-center justify-center z-10">
                    <div class="w-2 h-2 bg-white rounded-full"></div>
                </div>
                <div class="mt-4 text-center <?php echo e($isFinalApproved ? '' : 'opacity-40'); ?>">
