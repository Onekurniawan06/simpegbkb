<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white shadow-sm rounded-l-lg overflow-hidden border border-gray-100 mt-2 h-full flex flex-col">
        ...
        <div class="p-4 space-y-3 flex-grow overflow-y-auto custom-scroll-container">
            <?php $__empty_1 = true; $__currentLoopData = $paginatedSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <!-- Baris Pengajuan -->
                <div class="flex items-center p-2 bg-gray-100 border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="flex items-center gap-5 w-1/3">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-gray-800"><?php echo e($sub['display_info']['jenis_val']); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="hidden md:block w-64">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-sm font-bold text-gray-700">
                                <?php echo e($sub['display_info']['tgl_pengajuan_val']); ?>
                    ...
                    <div class="text-center w-40">
                        <span class="px-3 py-1 rounded-lg text-[12px] font-bold <?php echo e($sub['blade_class']); ?>">
                            <?php echo e($sub['blade_status_text']); ?>

                        </span>
                        <p class="text-[10px] text-gray-400 mt-1 italic"><?php echo e($sub['blade_stage']); ?></p>
                    </div>

                    <div class="w-54 text-right">
                        <a href="<?php echo e(route($sub['blade_route'], $sub['nomor_urut_pegawai'] ?? $sub['id'])); ?>"
        ...
        <div class="px-6 py-3 bg-gray-50 shrink-0">
            <?php echo e($paginatedSubmissions->links()); ?>
...
<?php echo $__env->make('layouts.app-manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\simpegbkb\resources\views/manager/pengajuanmanager.blade.php ENDPATH**/ ?>