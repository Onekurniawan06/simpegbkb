    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 h-full divide-x divide-slate-100">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $files ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="border-b border-slate-100 hover:bg-slate-50/50 transition">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <button type="button" onclick="openPdfModal('<?php echo e(route('skkmr.lihatDokumen', $file->id)); ?>')"
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $files ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="border-b border-slate-100 hover:bg-slate-50/50 transition">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <button type="button"
                                                        onclick="openPdfModal('<?php echo e(route('skkmr.lihatDokumen', $file->id)); ?>', '<?php echo e(str_replace('_', ' ', $file->tipe_dokumen)); ?>')"
                                                        class="text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 px-3 py-1.5 rounded-lg transition shadow-sm inline-block">
                                                    Lihat Dokumen
                                                </button>
                                            </td>
        ...
        <div class="lg:col-span-1 flex flex-col bg-slate-50 overflow-hidden border-l border-slate-100 h-full">
            ...
            <div class="flex-1 overflow-y-auto custom-scroll-container p-3 pb-5">
                <form id="formApproval" action="<?php echo e(route('skkmr.updateStatus', ['sumber' => $sumber, 'id_log' => $id_log])); ?>" method="POST" class="flex flex-col">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app-skkmr', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\simpegbkb\resources\views/skkmr/detail_approval.blade.php ENDPATH**/ ?>