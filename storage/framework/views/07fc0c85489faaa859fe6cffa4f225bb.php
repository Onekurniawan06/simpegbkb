...
<body class="flex flex-col min-h-screen bg-moving">
            ...
            <div class="bg-green-900 p-6 rounded-lg shadow-xl max-w-sm w-full m-4 text-white">
                <div class="flex items-start">
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="mt-1 text-sm text-green-100"><?php echo e(session('status')); ?></p>
    ...
    <div class="flex-grow flex items-center justify-center p-4">
        ...
        <div id="laravel-error-container" class="hidden">
            ...
            <?php echo e($errors->first('verification')); ?>

            <?php else: ?>
            <?php echo e($errors->first('is_verified')); ?>
...
<?php /**PATH C:\xampp\htdocs\simpegbkb\resources\views/login.blade.php ENDPATH**/ ?>