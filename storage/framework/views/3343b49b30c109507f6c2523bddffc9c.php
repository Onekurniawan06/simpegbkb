            ...
            <nav id="sidebar-content" class="flex-1 px-3 py-3 space-y-1 overflow-y-auto scrollbar-none">
                ...
                <div class="relative group">
                    ...
                    <div class="max-h-0 overflow-hidden group-hover:max-h-40 transition-all duration-300 ease-in-out bg-white/5 rounded-lg mx-1 border border-white/5 mt-1">
                        <a href="<?php echo e(route('skkmr.pengajuanskkmr')); ?>" class="block p-2 text-[11px] font-medium text-blue-100/70 hover:bg-blue-500/20 hover:text-blue-400 transition-colors border-b border-white/5 pl-11">
                            Pengajuan Saya
                        </a>
                        <a href="<?php echo e(route('skkmr.manajemenpengajuan')); ?>" class="block p-2 text-[11px] font-medium text-blue-100/70 hover:bg-blue-500/20 hover:text-blue-400 transition-colors pl-11">
                            Approval Pengajuan
                        </a>
                    </div>
                </div>
                ...
                <!-- Menu Data Pegawai -->
                <div class="relative group">
                    <a href="<?php echo e(route('pegawai.data')); ?>" class="flex items-center justify-between p-3 text-xs font-semibold rounded-xl hover:bg-blue-600 text-blue-100 hover:text-white transition-all duration-200 cursor-pointer">
                ...
                <a href="<?php echo e(route('laporan.index')); ?>" class="flex items-center justify-between p-3 text-xs font-semibold rounded-xl hover:bg-blue-600 text-blue-100 hover:text-white transition-all duration-200 cursor-pointer group">
                    <span class="flex items-center overflow-hidden">
                        <svg xmlns="http://w3.org" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-5 w-5 mr-3 text-blue-400 group-hover:text-white transition-colors shrink-0">
