        ...
        <aside id="sidebar" class="w-72 bg-gradient-to-b from-[#06101e] to-[#0b1523] text-white flex flex-col mt-2 ml-2 mr-2 transition-all duration-300 ease-in-out">
            ...
            <div class="p-5">
                <div class="flex justify-center items-center">
                    <img src="<?php echo e(asset('images/logoputih.png')); ?>" alt="Logo Bank Kota Bogor" class="h-10 w-auto filter drop-shadow-[0_4px_12px_rgba(59,130,246,0.3)]">
                </div>
            </div>
            ...
            <nav id="sidebar-content" class="flex-1 space-y-1.5 overflow-y-auto mt-3">
                ...
                <div class="px-2 mb-2">
                    ...
                    <div class="flex items-center mt-1 space-x-2">
                        ...
                        <span class="text-xs font-semibold text-white/90 truncate"><?php echo e($namaJabatan); ?></span>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div class="max-h-0 overflow-hidden group-hover:max-h-20 transition-all duration-500 ease-in-out bg-white/[0.02] rounded-xl mx-2 mt-1">
                        <a href="<?php echo e(url('/direktur/manajemenpengajuan')); ?>" class="block py-3 pl-10 pr-4 text-[11px] font-medium text-white/60 hover:text-blue-400 transition-colors">
                ...
                <!-- MENU DATA PEGAWAI -->
                <div class="relative group">
                    <a href="<?php echo e(route('pegawai.data')); ?>" class="flex items-center justify-between p-3.5 text-xs font-semibold rounded-xl transition-all duration-300 text-white/70 hover:bg-white/5 hover:text-white border-l-4 border-transparent hover:border-white/10 group">
                        <span class="flex items-center">
                ...
                <div class="relative group">
                    <a href="<?php echo e(route('laporan.index')); ?>" class="flex items-center justify-between p-3.5 text-xs font-semibold rounded-xl transition-all duration-300 text-white/70 hover:bg-white/5 hover:text-white border-l-4 border-transparent hover:border-white/10 group">
                        <span class="flex items-center">
                            <svg xmlns="http://www.w3.org" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-5 w-5 mr-3 text-white/40 group-hover:text-blue-400 transition-colors">
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-4.5 w-4.5 text-blue-500']); ?>
                        ...
                        <div class="relative group py-1">
                            <div class="flex items-center space-x-2 cursor-pointer p-1 hover:bg-gray-50 rounded-lg transition-colors">
                                <div class="flex flex-col text-xs text-right">
                                    <span class="font-semibold text-gray-800 leading-none"><?php echo e(Auth::user()->name ?? 'User'); ?></span>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-5 w-5 text-gray-400 group-hover:text-yellow-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-4 w-4 text-yellow-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                                                ...
                                                <div class="ml-2">
                                                    <p class="text-[11px] text-yellow-700 leading-tight">
                                                        ...
                                                        <a href="<?php echo e(route('profile.edit', ['form_type' => 'new'])); ?>" class="text-blue-700 hover:text-green-600 font-bold underline">
                                                            Isi Sekarang
                                                        </a>
                                                    </p>
                                                </div>
                                        ...
                                        <a href="<?php echo e(route('profile.edit', ['form_type' => 'new'])); ?>" class="flex items-center px-3 py-1.5 text-xs text-gray-500 hover:bg-gray-50 rounded-md group">
                                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-4.5 w-4.5 mr-2 text-gray-400 group-hover:text-yellow-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('profile.edit', ['form_type' => 'edit'])); ?>" class="flex items-center px-3 py-1.5 text-xs text-gray-700 hover:bg-gray-50 rounded-md group">
                                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('heroicon-o-identification'); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-4.5 w-4.5 mr-2 text-blue-500 group-hover:text-blue-600']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-4 w-4 ml-auto text-blue-500 opacity-0 group-hover:opacity-100 transition-opacity']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                                    ...
                                    <a href="<?php echo e(url('/change-password')); ?>" class="flex items-center px-3 py-1.5 text-xs text-gray-700 hover:bg-gray-50 rounded-md group">
                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                ...
                                <div class="p-1.5 border-t border-gray-100">
                                    <a href="<?php echo e(url('/logout')); ?>" class="flex items-center px-3 py-1.5 text-xs text-red-600 hover:bg-red-50 rounded-md w-full text-left group">
                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-4.5 w-4.5 mr-2 text-red-600 group-hover:scale-105 transition-transform']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
                            ...
                            <?php if(isset($breadcrumbs) && count($breadcrumbs) > 0): ?>
                                <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="inline-flex items-center">
                                        ...
                                        <?php endif; ?>
                                        <?php if($url): ?>
                                            <a href="<?php echo e($url); ?>" class="text-gray-600 hover:text-blue-600 flex items-center text-xs font-medium transition-colors">
                                                <?php if($loop->first): ?>
                                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-4 w-4 mr-1.5 text-gray-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php /**PATH C:\xampp\htdocs\simpegbkb\resources\views/layouts/app-direktur.blade.php ENDPATH**/ ?>