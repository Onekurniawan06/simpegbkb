            ...
            <nav id="sidebar-content" class="flex-1 px-2 py-4 space-y-2">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute left-full top-0 ml-4 w-64 bg-[#1e293b] shadow-2xl rounded-xl border border-white/10 invisible group-hover:visible opacity-0 group-hover:opacity-100 translate-x-3 group-hover:translate-x-0 transition-all duration-300 z-50 overflow-hidden">
                        <a href="<?php echo e(url('/manager/manajemenpengajuanmanager')); ?>" class="block p-4 text-[11px] font-bold hover:bg-amber-600 hover:text-white transition-colors">Approval Pengajuan Pegawai / Staff</a>
                    </div>
                </div>

                <!-- MENU DATA PEGAWAI -->
                <div class="relative group">
                    <a href="<?php echo e(route('manager.pegawaidivisi')); ?>" class="flex items-center justify-between p-3 text-[11px] font-bold rounded-xl transition-all duration-200 hover:bg-amber-600 hover:text-white group">
                        <span class="flex items-center">
                ...
                <div class="relative group">
                    <a href="<?php echo e(route('laporan.index')); ?>" class="flex items-center justify-between p-3 text-[11px] font-bold rounded-xl transition-all duration-200 hover:bg-amber-600 hover:text-white group">
                        <span class="flex items-center">
                            <svg xmlns="http://www.w3.org" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="h-5 w-5 mr-3 text-amber-500 group-hover:text-white">
