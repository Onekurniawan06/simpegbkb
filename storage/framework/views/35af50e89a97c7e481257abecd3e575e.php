            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                ...
                <div class="bg-amber-500 p-5 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-1xl font-semibold text-white"><?php echo e($totalMenunggu); ?> <span class="text-xs text-white">Data Pengajuan</span></p>
                        ...
                        <div class="mt-2 flex gap-3">
                            <?php $__currentLoopData = $detailMenunggu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="text-[10px] uppercase tracking-wider text-gray-500 bg-gray-100 px-2 py-1 rounded">
                                    <strong><?php echo e($detail['label']); ?> :</strong> <?php echo e($detail['jumlah']); ?>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $dataPengajuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="bg-white hover:bg-blue-50/50 transition-colors duration-150 h-px">
                                <td class="px-2 py-1.5 border-b border-r border-gray-200 text-center text-[11px] font-medium text-gray-600"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d-m-Y')); ?></td>
                                <td class="px-2 py-1.5 border-b border-r border-gray-200 text-center text-[11px] font-semibold text-gray-700"><?php echo e($item->nup); ?></td>
                                <td class="px-3 py-1.5 border-b border-r border-gray-200 text-center text-[11px] font-bold text-gray-800 uppercase leading-tight truncate"><?php echo e($item->nama); ?></td>
                                <td class="px-2 py-1.5 border-b border-r border-gray-200 text-center text-[11px] font-bold text-blue-600"><?php echo e($item->jenis); ?></td>
                                ...
                                <td class="px-2 py-1.5 border-b border-gray-200 text-center">
                                    <div class="flex flex-row justify-center items-center gap-1.5 whitespace-nowrap">
                                        <a href="<?php echo e(route('manager.detailApproval', ['sumber' => $item->sumber, 'id' => $item->id_transaksi])); ?>" class="bg-[#001f3f] hover:bg-black text-white py-1 px-2 rounded text-[8px] font-bold tracking-tighter transition shadow-sm">DETAIL</a>
...
<?php echo $__env->make('layouts.app-manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\simpegbkb\resources\views/manager/manajemenpengajuanpegawai.blade.php ENDPATH**/ ?>