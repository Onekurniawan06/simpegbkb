...
class PengajuanPensiunController extends Controller
{
    ...
    public function formPensiun()
    {
        ...
        // Cek apakah manager berdasarkan route_name
        ...
        $roleLabel = $roleMapping->role_name ?? 'Pegawai'; // Ambil label jabatan dulu

        $parentRouteName = $isManagerOrKepala ? 'manager.pilihpengajuan' : 'datapengajuan.formDataPengajuan';

        // Masukkan $roleLabel ke dalam string menggunakan tanda petik dua (" ")
        ...
        return view('pensiun.pensiun', compact(
            ...
            'pageTitle',
            'breadcrumbs',
            'parentRouteName', // Digunakan di action form atau tombol kembali
            'tmt_pegawai_formatted',
            'tmt_pensiun_otomatis',
            'submissionsType' // Digunakan untuk identitas modal
        ));
    }
    ...
    public function updatePensiun(Request $request)
    {
        ...
        // 2. Cek Pengajuan Pending (Gunakan penamaan variabel yang konsisten)
        ...
        try {
            ...
            LogPersetujuanPensiun::create([
                ...
                // 'update_at'          => Carbon::now(), // Pastikan nama kolom 'update_at' atau 'updated_at'
            ]);
                ...
                foreach ($request->file('documents') as $kodeDokumen => $file) {
                    if ($file->isValid()) {
                        ...
                        FilePersyaratanPensiun::create([
                            ...
                            'tipe_dokumen'         => $kodeDokumen, // Menyimpan kode dokumen
                        ]);
                    }
                }
            }
    ...
    public function statuspensiun($nip)
    {
        ...
        // 2. Ambil Data Pengajuan (Eager Loading relasi log dan files)
        ...
        // 6. LAYOUT OTOMATIS
        $layout = $user->layout_file; // Menggunakan Accessor otomatis Anda
