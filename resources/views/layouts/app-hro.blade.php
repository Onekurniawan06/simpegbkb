            ...
            <nav id="sidebar-content" class="flex-1 px-2 py-4 space-y-2">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute left-full top-0 ml-4 w-52 bg-gray-800 shadow-lg rounded-r-lg invisible group-hover:visible opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out z-50">
                        <!-- Menggunakan route name agar lebih aman dari error 404 -->
                        <a href="{{ route('hro.pengajuanhro') }}"
                        class="block p-2 text-xs hover:bg-amber-500 hover:text-white font-semibold rounded-tr-lg">
                        Pengajuan Saya
                        </a>

                        <a href="{{ route('hro.manajemenpengajuan') }}"
                        class="block p-2 text-xs hover:bg-amber-500 hover:text-white font-semibold rounded-br-lg">
                        Approval Pengajuan Pegawai
                        </a>
                    </div>
                </div>
                ...
                <!-- MENU DATA PEGAWAI -->
                <div class="relative group">
                    {{-- Update link ke route yang sesuai untuk HRO jika sudah ada --}}
                    <a href="{{ route('pegawai.data') }}" class="flex items-center justify-between p-3 text-xs font-medium rounded-lg hover:bg-amber-500 hover:text-white transition duration-150 cursor-pointer">
                        <span class="flex items-center">
                            ...
                            <span class="sidebar-text whitespace-nowrap overflow-hidden text-ellipsis">
                                {{-- Langsung ganti jadi teks untuk HRO tanpa @if --}}
                ...
                <div class="relative group" id="laporan-menu-container">
                    ...
                    <a href="#" class="flex items-center justify-between p-3 text-xs font-medium rounded-lg hover:bg-amber-500 hover:text-white transition duration-150 cursor-pointer">
                        <span class="flex items-center">
                            ...
                            <span class="sidebar-text whitespace-nowrap overflow-hidden text-ellipsis">
                                {{-- Langsung ganti jadi teks statis untuk HRO --}}
