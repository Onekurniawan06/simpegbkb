        ...
        <aside id="sidebar" class="w-72 bg-gray-800 text-white flex flex-col shadow-lg transition-all duration-300 ease-in-out rounded-r-md">
            ...
            <nav id="sidebar-content" class="flex-1 px-2 py-4 space-y-2">
                ...
                <a href="{{ Auth::user()->dashboard_link }}"
                    class="flex items-center justify-between p-3 text-sm font-medium rounded-lg hover:bg-amber-500 hover:text-white transition duration-150">
                ...
                <div class="relative group">
                    ...
                    <a href="#" class="flex items-center justify-between p-3 text-sm font-medium rounded-lg hover:bg-amber-500 hover:text-white transition duration-150 cursor-pointer">
                        <span class="flex items-center">
                            <!-- Icon Utama -->
                    ...
                    <div class="absolute left-full top-0 ml-4 w-52 bg-gray-800 shadow-lg rounded-r-lg invisible group-hover:visible opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out z-50">
                        ...
                        <a href="{{ url('/skkmr/pengajuanskkmr') }}" class="block p-2 text-sm hover:bg-amber-500 hover:text-white font-semibold rounded-tr-lg">Pengajuan Saya</a>
                        <a href="{{ url('/manager/manajemenpengajuanmanager') }}" class="block p-2 text-sm hover:bg-amber-500 hover:text-white font-semibold rounded-br-lg">Approval Pengajuan</a>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <a href="#" class="flex items-center justify-between p-3 text-sm font-medium rounded-lg hover:bg-amber-500 hover:text-white transition duration-150 cursor-pointer">
                        <span class="flex items-center">
                            ...
                            <span class="sidebar-text whitespace-nowrap">Data Unit Kepatuhan & Resiko</span>
                        </span>
                        <!-- Icon Chevron: class group-hover:text-white tetap berfungsi karena parent-nya sudah benar -->
                        <svg xmlns="http://www.w3.org" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-3 w-3 group-hover:text-white">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5" />
                ...
                <div class="relative group" id="laporan-menu-container">
                    ...
                    <div class="absolute left-full top-0 ml-4 w-72 bg-gray-800 shadow-lg rounded-r-lg invisible group-hover:visible opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out z-50">
                        <a href="#" class="block p-3 text-sm hover:bg-amber-500 hover:text-white font-semibold rounded-tr-lg">Laporan Absensi Pegawai</a>
                        <a href="{{ route('laporan.index') }}" class="block p-3 text-sm hover:bg-amber-500 hover:text-white font-semibold rounded-br-lg">Laporan Pengajuan Pegawai</a>
                    </div>
                </div>
            </nav>
        </aside>
