            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 ml-2 mr-2">
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800 mt-1">{{ number_format($totalMenunggu) }} <span class="text-xs text-gray-400 font-medium">Data</span></p>
                    </div>
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800 mt-1">{{ number_format($totalDisetujui) }} <span class="text-xs text-gray-400 font-medium">Data</span></p>
                    </div>
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800 mt-1">{{ number_format($totalDitolak) }} <span class="text-xs text-gray-400 font-medium">Data</span></p>
                    </div>
