...
<div class="rounded-l-md shadow-lg">
    <!-- Card Statistik: Pengajuan Menunggu Persetujuan Direktur -->
    <div class="bg-amber-600 rounded-l-md p-3 text-white shadow-xl relative overflow-hidden group hover:shadow-2xl transition-all duration-300">
        ...
        <div class="relative z-10">
            <div class="flex justify-between items-start">
                <div>
                    <!-- Label diganti menjadi lebih umum untuk Direktur -->
                    <h2 class="text-sm font-bold uppercase tracking-[0.15em] text-white opacity-90 mb-1">Persetujuan {{ $jabatanLogin }}</h2>
                    <div class="flex items-baseline gap-2 mb-5">
                        <span class="text-4xl font-black">{{ $totalMenunggu }}</span>
                        <span class="text-xs font-medium text-amber-100 uppercase tracking-widest">Antrean Pengajuan</span>
                    </div>
                </div>

                <div class="bg-white/20 p-3 rounded-xl backdrop-blur-md border border-white/30 shadow-inner">
                    <svg xmlns="http://w3.org" class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
            </div>

            <!-- List Badge Dinamis (Pastikan $detailMenunggu dikirim dari Controller) -->
                    ...
                    @foreach($detailMenunggu as $detail)
                        ...
                        <div class="bg-white/10 backdrop-blur-sm border border-white/20 px-4 py-2 rounded-xl flex items-center gap-3 hover:bg-white/20 transition-colors cursor-default">
                            <div class="flex flex-col">
                                <span class="text-[9px] font-black text-amber-50 uppercase tracking-tighter leading-none mb-1">{{ $detail['label'] }}</span>
