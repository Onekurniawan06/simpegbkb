...
<form action="{{ route('pensiun.updatePensiun') }}" method="POST" id="leaveFormPensiun" enctype="multipart/form-data">
@csrf
@method('PUT')
    ...
    <div class="flex-1 overflow-y-auto h-[calc(100vh-120px)] space-y-2 custom-scroll-container">
        <div class="bg-white rounded-lg shadow-lg max-w-full mx-auto">
            ...
            <div style="background-image: linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.1)), url('{{ asset('images/vecteezylight.jpg') }}')" class="bg-cover bg-bottom p-2 rounded-t-lg relative">
                    <img src="{{ asset('images/retired.png') }}" alt="Overtime" class="absolute right-0 top-0 h-40">
                    ...
                    <div class="grid grid-cols-3 gap-5">
                        <div class="flex-1">
                            ...
                            <div class="relative mt-1">
                                <input name="tmt_pegawai" id="tmt_pegawai" value="{{ $tmt_pegawai_formatted ?? '' }}" type="text" class="w-full bg-gray-50 placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 pr-10 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow read-only:cursor-not-allowed" placeholder="TMT Pegawai" readonly />
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-4xl mx-auto">
                    ...
                    <div class="mt-4">
                        <div class="custom-scroll-container p-4" style="max-height: 70vh; overflow-y: auto;">
                            @include('partials.pensiun_letter_content')
                        </div>
                    </div>
