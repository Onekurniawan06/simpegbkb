...
<div id="successModal" class="{{ Session::has('success') ? 'flex' : 'hidden' }} fixed inset-0 bg-black/50 items-center justify-center z-50 backdrop-blur-sm">
    <div class="bg-gray-50 p-8 rounded-xl shadow-2xl w-full max-w-lg mx-4 relative">
        ...
        <div class="text-center">
            ...
            <h2 class="mt-4 text-2xl font-bold text-gray-900">
                {{ Session::get('modal_title') ?? 'Berhasil!' }}
            </h2>
        ...
        {{-- <div class="mt-6 flex justify-center">
            <a href="{{ Session::get('modal_link') ?? '#' }}" class="px-6 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700">
                Lihat Pengajuan
            </a>
        </div> --}}
    </div>
